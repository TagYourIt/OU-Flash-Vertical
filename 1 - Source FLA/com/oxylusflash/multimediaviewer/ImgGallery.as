package com.oxylusflash.multimediaviewer 
{
	 ...
	 */
	public class ImgGallery extends MultimediaViewer
	{
		//{ region FIELDS
		...
		private final function dataLoader_IoErrorHandler(e:IOErrorEvent):void 
		{
			...
			trace("data loader IOError, class ImgGallery.as", e);
		...
		override internal function closeBtn_MouseDownHandler(e:MouseEvent):void 
		{
			btn_mc.drag = true;
		...
		public final function LoadMe(pURL : String = "", pLink : String = "", pTarget : String = ""):void 
		{
			...
			{
				trace("Picture load failure, class ImgGallery.as", err);
			}
		}
		//} endregion
